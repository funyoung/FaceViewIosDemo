...
- (void)drawRect:(CGRect)rect
{
    ...
    // draw face [circle]
    CGPoint aidPoint;
    aidPoint.x = self.bounds.origin.x + self.bounds.size.width/2;
    aidPoint.y = self.bounds.origin.y + self.bounds.size.height/2;
    ...
    [self drawCircleAtPoint:aidPoint withRadius:size inContext:context];
    // draw eyes [2 circle]
#define EYE_H 0.35
#define EYE_V 0.35
#define EYE_RADIUS 0.10
    ...
    CGPoint eyePoint;
    eyePoint.x = aidPoint.x - size * EYE_H;
    eyePoint.y = aidPoint.y - size * EYE_V;
...
#define MOUTH_SMILE 0.25
    ...
    CGPoint mouthStart;
    mouthStart.x = aidPoint.x - MOUTH_H * size;
    mouthStart.y = aidPoint.y + MOUTH_V * size;
